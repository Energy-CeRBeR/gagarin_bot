...
USER_COMMANDS: dict = {
    "/start": {
        "in_base": "Приветствуем! Для перехода в меню введите команду /menu",
        "no_base": "Приветствуем! Для перехода в меню введите команду /menu"
    },
    "/menu": "Cписок команд:\n"
    ...
    "/auth": {
        ...
        "success_auth": "Вход в аккаунт успешно выполнен!"
    },
    "/fill_page": {
